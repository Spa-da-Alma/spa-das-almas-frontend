  ...
  pt: {
    translations: {
      ...
      cottage: {
        martigny: {
          name: "martigny",
          description: "Decoração estilo rústico e artesanal,  todo envidraçado com vista privilegiada  para a montanha e o pôr do sol.  Sistema de calefação de ambiente e ar condicionado.  Cama kingsize com enxoval de 1000 fios e toalhas felpudas.  Espaço da lareira com sofá-cama grande e Smart TV 4K, com home theater.  Mini cozinha com cooktop, pia, frigobar, microondas,  utensílios básicos, aparelho para fondue e cafeteira Nespresso.  Banheira com hidromassagem para até 3 pessoas e teto solar.  O banheiro com piso aquecido e toalheiro térmico, lavatórios e duchas duplas. Ambiente com escrivaninha e cadeira de escritório. Internet por fibra óptica."
        },
        chamonix: {
          name: "chamonix",
          description: "Uma suíte ou dois quartos com sala de jantar, lareira e cozinha americana, banheiro com ofurô, lavabo e vista para o bosque de araucárias e pinheiros!",
        },
        mont_blanc: {
          name: "mont blanc",
          description: "Uma Suíte com  hidromassagem dupla no quarto, banheiro e deck panorâmico privativo com vista para o bosque!",
        },
        monviso: {
          name: "monviso",
          description: "Chalé com cinco quartos, que acomodam até doze Pessoas, de frente para a piscina, sala de jantar, sala com lareira e sala de jogos!",
        },
        cheverny: {
          name: "cheverny",
